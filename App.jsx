...
======================================`;
  ...
  <div className="mt-6 bg-white/50 rounded-2xl p-4 md:p-6 space-y-5 border border-emerald-200">
    ...
    <div className="bg-indigo-50/50 rounded-xl p-4 border border-indigo-200">
        ...
        <div className="bg-white rounded-xl p-3 space-y-2 shadow-inner">
          ...
          <div className="mt-2">
            <div className="flex justify-between text-[9px] text-zinc-500 mb-1">
              ...
              <span>{((p.advancePayment?.amount || 0) / ((((p.prodCostUSD || 0) * (p.unitsQty || 0) + (p.yiwuFreightUSD || 0)) * (p.dollarRate || 0) * 1.03)) * 100).toFixed(1)}%</span>
            </div>
            <div className="h-2 bg-zinc-200 rounded-full overflow-hidden">
              <div className="h-full bg-indigo-500 rounded-full transition-all" style={{ width: `${Math.min(((p.advancePayment?.amount || 0) / ((((p.prodCostUSD || 0) * (p.unitsQty || 0) + (p.yiwuFreightUSD || 0)) * (p.dollarRate || 0) * 1.03)) * 100, 100)}%` }}></div>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center border-t border-zinc-200 pt-2 mt-2">
            ...
            <span className={`font-mono font-bold text-lg ${((((p.prodCostUSD || 0) * (p.unitsQty || 0) + (p.yiwuFreightUSD || 0)) * (p.dollarRate || 0) * 1.03) - (p.advancePayment?.amount || 0)) > 0 ? 'text-rose-600' : 'text-emerald-600'}`}>
          ...
          <div className="flex justify-between items-center">
            ...
            <span className={`font-mono font-bold ${((((p.prodCostUSD || 0) * (p.unitsQty || 0) + (p.yiwuFreightUSD || 0)) * (p.dollarRate || 0) * 1.03) - (p.advancePayment?.amount || 0)) > 0 ? 'text-rose-600' : 'text-emerald-600'}`}>
              ${((((p.prodCostUSD || 0) * (p.unitsQty || 0) + (p.yiwuFreightUSD || 0)) * (p.dollarRate || 0) * 1.03) - (p.advancePayment?.amount || 0)) / (p.dollarRate || 1)} USD
            </span>
          </div>
      ...
      {((((p.prodCostUSD || 0) * (p.unitsQty || 0) + (p.yiwuFreightUSD || 0)) * (p.dollarRate || 0) * 1.03) - (p.advancePayment?.amount || 0)) === 0 && (((p.prodCostUSD || 0) * (p.unitsQty || 0) + (p.yiwuFreightUSD || 0)) > 0) && (
